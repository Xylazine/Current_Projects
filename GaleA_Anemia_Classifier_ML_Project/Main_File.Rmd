---
title: "Ensemble Model to Predict Anemia Diagnosis"
subtitle: "DA5030"
author: "Gale, Amanda"
date: "Fall 2025"
output: 
...
3. Hyperparameter boundaries are adjusted until the final model settles somewhere in the center of the given values. This full process is possible to display here but has been cut down for the sake of minimizing run time of the program.
...
def ensemble(new_data, model1=svc_model, model2=rf_model, model3=ann_model, 
f1_1=svc_mean_f1, f1_2=rf_mean_f1, f1_3=ann_mean_f1):
...
## References
- Artificium - Dr. Martin Schedulbauer 
